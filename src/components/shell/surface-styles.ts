export const featuredSurfaceClass =
...
export const warmMetricCardClass =
...
export const warmMetricEyebrowClass = "text-xs font-semibold uppercase tracking-[0.2em] text-warm";

export const warmMetricValueClass = "mt-2 text-3xl font-bold tracking-tight text-warm-strong dark:text-warm";

export const warmIconChipClass =
  "rounded-full bg-warm-soft p-2 text-warm dark:bg-warm/18 dark:text-warm";

export const warmSectionCardClass =
...
export const warmSectionHeaderClass =
...
export const warmSectionTitleClass = "text-warm-strong dark:text-warm";

export const warmTableSurfaceClass =
